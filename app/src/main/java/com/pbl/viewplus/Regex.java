...
//        Matcher addressMasking = maskingPattern.get(7).matcher(inputData); //주소
        ...
        confirmMatcher.add(maskingPattern.get(1).matcher(inputData));//카드번호. 국내 앞자리 34569
        confirmMatcher.add(maskingPattern.get(2).matcher(inputData));//휴대폰 번호
        confirmMatcher.add(maskingPattern.get(3).matcher(inputData));//휴대폰 번호(띄어쓰기 버전)
        confirmMatcher.add(maskingPattern.get(4).matcher(inputData));//휴대폰 번호(붙여쓴 버전)
        confirmMatcher.add(maskingPattern.get(5).matcher(inputData));//전화 번호 -서울이거나 다른지역
        confirmMatcher.add(maskingPattern.get(6).matcher(inputData));//주민등록번호
    ...
    public static String doMasking(String input){
        ...
        Matcher phoneNumberMasking = confirmMatcher.get(1);//카드번호. 국내 앞자리 34569
        Matcher phoneBlankMasking = confirmMatcher.get(2);//휴대폰 번호
        Matcher phoneNoBlankMasking = confirmMatcher.get(3);//휴대폰 번호(띄어쓰기 버전)
        Matcher houseNumberMasking = confirmMatcher.get(4);//휴대폰 번호(붙여쓴 버전)
        Matcher personNumberMasking = confirmMatcher.get(5);//전화 번호 -서울이거나 다른지역
        Matcher cardMasking = confirmMatcher.get(6);//주민등록번호
