...
public class IntroSliderScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String p3= "해당 기능을 사용하시려면\n 1\n 상단의 카메라 버튼을 눌러 사진을 촬영하거나 \n갤러리 버튼을 눌러 원하는 사진을 불러옵니다\n" +
                "2\n 분석이 완료되면 분석 결과가 아래에 나타나고 음성으로 글자를 읽어줍니다\n"+
                "3\n 양 옆 돋보기 버튼으로 글자 크기를 조정할 수 있으며 가운데 다시 듣기 버튼으로 결과를 다시 재생할 수 있습니다";
        String p4= "웹 브라우저는 인터넷 사용이 가능하고 인터넷 사용 도중 원하는 이미지를 분석해주는 기능입니다.\n";
        String p5= "다음 단계로 진행합니다\n 1\n 검색창에 직접 주소를 입력하거나 붙여넣기 버튼을 사용해 주소를 붙여 넣어 원하는 사이트를 검색할 수 있습니다.\n" +
                "2\n 웹 브라우저 사용 도중, 이미지를 길게 눌러 해당 이미지를 복사합니다.\n" +
                "3\n 문자 인식이나 이미지 묘사 버튼을 눌러 분석을 진행합니다\n";
        String p6= "과거 기록은 사용자의 과거 분석 결과를 다시 볼 수 있는 기능입니다.\n";
        String p7= "1\n 오늘을 포함한 5일 간의 기록이 보관됩니다.\n" +
                "2\n 사진을 클릭하여 과거 분석 결과를 확인할 수 있습니다.\n" +
                "3\n 사진 옆의 X 버튼을 눌러 해당 정보를 삭제할 수 있습니다.\n" +
                "이상 튜토리얼이 완료되었습니다   다음을 눌러 앱을 시작해주세요";
